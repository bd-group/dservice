...
plot \
     "< awk -F, 'BEGIN{cts=0;} {if (cts == 0) cts = $42; print ($42 - cts) \" \" $28-$29;}' FIXME_REPORT_FILE" \
	using 1:2 t "Active Conn.  Y1" w linesp ls 1 axes x1y1, \
     "< awk -F, 'BEGIN{lasts=0;lastt=0;cts=0;} {if (cts == 0) cts = $42; if (lasts >= 0 && ($30 - lasts) >= 0) print ($42 - cts) \" \" ($30-lasts)/($42-lastt); lastt=$42;lasts=$30;}' FIXME_REPORT_FILE" \
	using 1:2 t "Query Rate Y2" w linesp ls 3 axes x1y2
#     "< awk -F, 'BEGIN{cts=0;} {if (cts == 0) cts = $42; print ($42 - cts) \" \" $28;}' FIXME_REPORT_FILE" \
