...
//					}
				...
				case MSGType.MSG_MODIFY_SCHEMA_ALT_COL_TYPE:{
					String schemaName = (String) msg.getMsg_data().get("schema_name");
					GlobalSchema gls = msClient.client.getSchemaByName(schemaName);
					writeObject(ObjectType.GLOBALSCHEMA, schemaName, gls);
					break;
				}
				case MSGType.MSG_DEL_SCHEMA:{
					String schemaName = (String) msg.getMsg_data().get("schema_name");
					removeObject(ObjectType.DATABASE, schemaName);
					break;
				}
			}
